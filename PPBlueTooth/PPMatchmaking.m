...
@interface PPMatchmaking () <MCSessionDelegate, MCNearbyServiceAdvertiserDelegate, MCNearbyServiceBrowserDelegate>
                        ...
                        displayName:(NSString *)displayName
{
  ...
  if (self)
  {
    ...
    self.endGameStatus = _endGameStatus;
  }
  return self;
}
...
- (void)joinParty:(NSString*)gameStatus
{
...
- (void)session:(MCSession *)session peer:(MCPeerID *)peerID didChangeState:(MCSessionState)state
{
  dispatch_async(dispatch_get_main_queue(), ^{
    [self.delegate partyTime:self peer:peerID changedState:state currentPeers:self. session.connectedPeers gameStatus:self.endGameStatus];
  });
}
