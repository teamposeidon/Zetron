...
- (void) createZetronNodeWithAnimation {
    ...
    self.zetron = [SKSpriteNode spriteNodeWithImageNamed:@"ZetronVirus1"];
    self.zetron.position = CGPointMake(20, 50);
    self.zetron.size = CGSizeMake(80, 80);
    
    SKTexture *texture1 = [SKTexture textureWithImageNamed:@"ZetronVirus1"];
    SKTexture *texture2 = [SKTexture textureWithImageNamed:@"ZetronVirus2"];
